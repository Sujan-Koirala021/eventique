        ...
        <div className=' text-gray-800 bg-white py-4'>
            <div className='flex flex-col md:flex-row justify-around m-6 p-7'>
                ...
                <div className='flex flex-col mb-6 md:mb-0'>
                    ...
                    <div className='mb-2'>About Eventique</div>
                ...
                <div className=''>
                    ...
                    <form className='flex flex-col'>
                        <input
                            ...
                            className='border-b-2 border-gray-300 bg-transparent mb-4 p-2 outline-none focus:border-orange-400 transition-all duration-300'
                        />
                        <button
